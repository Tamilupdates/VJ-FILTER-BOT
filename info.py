...
MELCOW_VID = environ.get("MELCOW_VID", "https://telegram.me/How_To_Open_Linkl")
...
SUBSCRIBE_URL = environ.get('SUBSCRIBE_URL', 'https://telegram.me/vj_bots')
TUTORIAL = environ.get('TUTORIAL', 'https://telegram.me/How_To_Open_Linkl')
...
DOMAIN = str(getenv('DOMAIN', BIND_ADRESS)) if not ON_HEROKU or getenv('DOMAIN') else APP_NAME+'.herokuapp.com'
URL = "https://demo-gsmz.onrender.com".format(DOMAIN) if ON_HEROKU or NO_PORT else \
    "https://demo-gsmz.onrender.com/".format(DOMAIN, PORT)
...
if HAS_SSL:
    URL = "https://demo-gsmz.onrender.com/".format(DOMAIN)
else:
    URL = "https://demo-gsmz.onrender.com/".format(DOMAIN)
